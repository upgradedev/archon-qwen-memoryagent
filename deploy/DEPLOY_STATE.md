...
- **Real recall:** `modelId: qwen-plus`, genuine synthesized answer (not the deterministic fake template), real cosine scores (top insight distance 0.29 / score 0.71), `company` filter correctly excluded ByteCraft. Sample answer: _"The off-bank employment cost at ACME SA for 2026-05 is €5,800 — the gap between the bank salary transfer of €10,000 and the true employer cost of €15,800 [2]. This €5,800 wedge represents 28.0% of the bank transfer and consists mostly of employer social-security contributions of €2,800 [1]..."_
