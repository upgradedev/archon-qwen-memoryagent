...
| Alibaba deployment | `Dockerfile`, `docker-compose.yml`, `deploy/DEPLOY_STATE.md`, `demo/ALIBABA_PROOF.md`, live `/health` and `/ready` | The qualifying live path is an Alibaba Cloud ECS compose stack with PostgreSQL/pgvector. Exact runtime source `e4b208a63e1768409e5b94fe305a3672c4c96dcd` passed checkout/build, schema/least-privilege/cross-database, real-Qwen, TLS, grounded-recall/cleanup, and v4 idempotent reconciliation gates. Function Compute + managed pg-wire store is an alternative artifact, not the claimed active topology. |
...
| Exact deployed runtime source | Verified live [`e4b208a63e1768409e5b94fe305a3672c4c96dcd`](https://github.com/upgradedev/archon-qwen-memoryagent/commit/e4b208a63e1768409e5b94fe305a3672c4c96dcd); submission-pack-only descendants may move repository HEAD · [`deploy/DEPLOY_STATE.md`](../deploy/DEPLOY_STATE.md) |
