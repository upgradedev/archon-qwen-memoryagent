...
def browser_capture(
    ...
    with sync_playwright() as playwright:
        ...
        composite_live_capture(
            ...
            subtitle="A new browser session asks by meaning; pgvector recall supplies the bounded evidence and qwen-plus grounds the answer in numbered sources.",
        ...
        composite_live_capture(
            ...
            subtitle="INV-5521 preserves Session A and Session B provenance, then recommends the later 8,900 value under the declared recency rule.",
        ...
        composite_live_capture(
            ...
            subtitle="“Always pays on time” and “chronically late” share no numeric field. A bounded qwen-plus judge detects the opposed meaning and returns a read-only recommendation.",
