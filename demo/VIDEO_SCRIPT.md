...
| 7 · Meaning + MCP | 1:53–2:10 | “always pays on time” vs “chronically late”, visible bounded Qwen insight result, four-tool MCP card | Show that the live Explorer judges at most one eligible, highest-similarity insight pair (`maxPairs: 1`). Separate that working mechanism from the offline 90% fixture and distinguish authenticated HTTP from trusted-local stdio. |
